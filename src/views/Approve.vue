...
export default {
  name:'request',
  components:{
    PageToolbar,ActionMenu,Search,EditApprove,ViewRequestDetail
  },
  created(){
    this.loadList();
  },
  ...
  methods:{
    ...
    loadList(){
      ...
      this.axios
        .post("ATKRequest/loadApprove", id)
        .then(response => {
    ...
    loadFilter(){
      this.axios
        .post("ATKRequest/loadApproveFilterList", {})
        .then(response => {
